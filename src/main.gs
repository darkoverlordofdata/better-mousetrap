    ...
    class Basic : sdx.Application implements ApplicationListener
        ...
        def private drawSprite(ref e:Entity*)
            ...
            if (e.kind != Kind.BACKGROUND) 
                ...
                if e.tint != null
                    e.sprite.texture.texture.set_color_mod((uint8)e.tint.r, (uint8)e.tint.g, (uint8)e.tint.b)
                    e.sprite.texture.texture.set_alpha_mod((uint8)e.tint.a)
                
            renderer.copy(e.sprite.texture.texture, null, e.bounds)
